              ...
              <div className="max-h-[70vh] overflow-y-auto">
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">Assessment & Schedule Type</label>
                      <input
                        type="text"
                        placeholder='Initial (Announced)'
                    ...
                    <div>
                      ...
                      <input
                        type="text"
                        placeholder='Social Compliance Assessment'
